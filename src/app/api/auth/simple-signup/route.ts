...
import { createUser, createAuthResponse } from '@/lib/simple-auth';
...
export async function POST(req: Request) {
  try {
    ...
    console.log('📝 SIMPLE SIGNUP: Creating user for email:', email);
    ...
    console.log('📝 SIMPLE SIGNUP: Password hashed');
