...
const uri = process.env.MONGODB_URI || 'mongodb+srv://gonana:YRJXv3mTD2Xtt854@churchflow.mnlhhpg.mongodb.net/ecwa-settings?retryWrites=true&w=majority&appName=Churchflow';
const options = {
  maxPoolSize: 10,
